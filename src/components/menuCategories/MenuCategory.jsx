...
function MenuCategory() {
  return (
    <div className={styles.categoryList}>
        ...
        <Link href='/blog?cat=culture' className={`${styles.categoryItem} ${styles.travel}`}>Travel</Link>
        <Link href='/blog?cat=culture' className={`${styles.categoryItem} ${styles.coding}`}>Coding</Link>
